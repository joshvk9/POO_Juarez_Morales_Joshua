            ...
            case 1: //problema 1
                ...
                */ 
                ...
                case 3:
                    ...
                    System.out.print("Digite la temperatura en grado en grado Fahrenheit: ");
                    double gradosFrahrenheit = double.Double.parseDouble(entrada.nextLine());
                    System.out.println("%.2f °F = %.2f  °C\n", gradosFrahrenheit, resultado);
                

                    Public static double convertirFaherenheitACelsius(double gradosFrahrenheit){
                        double celsius = ((5 * (gradosFrahrenheit - 32))/ 9.0);
